<div class="row">
    <form class="form-horizontal" id="myForm" action="<?=base_url().'admin/tag/save_data'?>" method="post" enctype="multipart/form-data">
        <div class='col-md-12'>
            <div class='box box-info'>
                ...
                <div class='box-body'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text"  class="form-control firstInput" id="nama_album" name="nama_album" placeholder="Masukan Nama Album...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Seo Album </label>
                        <div class="col-md-6">
                            <input type="text" class="form-control secondInput" id="seo_album" name="seo_album" placeholder="Masukan Seo Album...">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="file"  id="cover" name="file_foto" class="form-control" onchange="loadFile(event)" /><br>
                                <img id="foto_cover" style="width:30%;border: 1px solid #ddd;border-radius: 4px;padding: 5px;width: 150px;"  src="<?=base_url()?>assets/images/album/default.png">
                        </div>
                    </div>
