            ...
            <div class='box box-info'>
                ...
                <div class='box-body'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text"  class="form-control firstInput" id="nama_tag" name="nama_tag" placeholder="Masukan Nama Tag...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Seo Tag </label>
                        <div class="col-md-6">
                            <input type="text" class="form-control secondInput" id="seo_tag" name="seo_tag" placeholder="Masukan Seo Tag...">
                        </div>
                    </div>
