            ...
            <div class='box box-info'>
                ...
                <div class='box-body'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control firstInput" id="nip" name="nip" placeholder="Masukan NIP Guru...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Nama </label>
                        <div class="col-md-6">
                            <input type="text" class="form-control firstInput" id="nama" name="nama" placeholder="Masukan Nama Lengkap...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Tanggal Lahir </label>
                        <div class="col-md-6">
                            <input type="date" class="form-control firstInput" id="tanggal_lahir" name="tanggal_lahir">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Tempat Lahir </label>
                        <div class="col-md-6">
                            <input type="text" class="form-control firstInput" id="tempat_lahir" name="tempat_lahir" placeholder="Masukan Tempat Lahir...">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control firstInput" id="agama" name="agama" placeholder="Masukan Agama...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Pendidikan </label>
                        <div class="col-md-6">
                            <input type="text" class="form-control firstInput" id="pendidikan" name="pendidikan" placeholder="Masukan Pendidikan yang Ditempuh...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Mata Pelajaran </label>
                        <div class="col-md-6">
                            <input type="text" class="form-control firstInput" id="mata_pelajaran" name="mata_pelajaran" placeholder="Sebagai Apakah Beliau...">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="file"  id="cover" name="file_foto" class="form-control" onchange="loadFile(event)" /><br>
                                <img id="foto_cover" style="width:30%;border: 1px solid #ddd;border-radius: 4px;padding: 5px;width: 150px;"  src="<?=base_url()?>assets/images/page/default.png">
                        </div>
                    </div>
