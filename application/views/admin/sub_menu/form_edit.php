            ...
            <div class='box box-info'>
                ...
                <div class='box-body'>
                    ...
                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Nama Sub Menu </label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="nama_sub_menu" name="nama_sub_menu" placeholder="Masukan Nama Sub Menu..." value="<?=$getData->nama_sub_menu?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Main Menu</label>
                        <div class="col-md-6">
                            <select class="form-control" name="id_main_menu" id="id_main_menu">
                                ...
                                <?php
                                    foreach($getMainMenu as $row) {
                                        $selected = "";
                                        if($row->id == $getData->id_main_menu) {
                                            $selected = "selected";
                                        }
                                    ?>
                                    <option value="<?=$row->id?>" <?=$selected?> ><?=$row->nama_menu?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="link_sub_menu" name="link_sub_menu" placeholder="Masukan Link Sub Menu..." value="<?=$getData->link_sub_menu?>">
                        </div>
                    </div>
                    <div class="form-group">
