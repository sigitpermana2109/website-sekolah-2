            ...
            <div class='box box-info'>
                ...
                <div class='box-body'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="nama_menu" name="nama_menu" placeholder="Masukan Nama Menu...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Link / URL <span style="color:red">*</span></label>
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="link" name="link" placeholder="Masukan Link / URL...">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <select class="form-control" name="admin_menu" id="admin_menu">
                                ...
                                <option value="no">iya</option>
                            </select>
                        </div>
                    </div>

                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Default page</label>
                        <div class="col-md-3">
                            <select class="form-control" name="keterangan" id="keterangan">
                                <option value="single_menu">Single Menu</option>
                                <option value="multiple_menu">Dynamic Menu</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="number" min=0 class="form-control" id="urutan" name="urutan" placeholder="Masukan Urutan Menu...">
                        </div>
                        <div class="col-md-3">
                            <select class="form-control" name="keterangan" id="keterangan">
                                <option value="single_menu">Single Menu</option>
                                <option value="multiple_menu">Multiple Menu</option>
                            </select>
                        </div>
                    </div>
