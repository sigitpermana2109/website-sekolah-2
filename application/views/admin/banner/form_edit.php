            ...
            <div class='box box-info'>
                ...
                <div class='box-body'>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control" id="nama_banner" name="nama_banner" placeholder="Masukan Nama Banner..." value="<?=$getData->nama_banner?>">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="file"  id="foto" name="file_foto" class="form-control" onchange="loadFile(event)" /><br>
                                <img id="foto_banner" style="width:30%;border: 1px solid #ddd;border-radius: 4px;padding: 5px;width: 150px;"  src="<?=base_url()?>assets/images/banner/<?=$getData->foto ?>">
                        </div>
                    </div>
