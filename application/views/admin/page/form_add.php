                ...
                <div class='box-body'>
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="text" class="form-control firstInput" id="judul_page" name="judul_page" placeholder="Masukan Judul Page...">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Seo Page </label>
                        <div class="col-md-6">
                            <input type="text" class="form-control secondInput" id="seo_page" name="seo_page" placeholder="Masukan Seo Page...">
                        </div>
                    </div>
                     <div class="form-group">
                        <label for="inputEmail3" class="col-md-2 control-label">Deskripsi</label>
                        <div class="col-md-9">
                            <textarea class="form-control" id="deskripsi" name="deskripsi" rows="10" cols="20"></textarea>
                     ...
                     <div class="form-group">
                       ...
                       <div class="col-md-6">
                            <select class="form-control select2" name="tag[]" id="tag" multiple style="width: 100%;" placeholder="Silahkan pilih tag">
                                <?php
                                    foreach($get_tag as $row) { ?>
                                    <option value="<?=$row->id?>" ><?=$row->nama_tag?></option>
