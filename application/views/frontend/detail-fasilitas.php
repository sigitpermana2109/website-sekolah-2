      ...
      <div class="col-md-8 col-lg-9">
        <div class="card">
          <div class="position-relative">
            <img class="card-img-top" src="<?=base_url()?>/assets/images/page/<?=$fasilitas->cover?>" alt="Card image cap">
          </div>
          <div class="card-body border-top-5 px-3 rounded-bottom border-warning">
            <h3 class="card-title text-warning mb-4"><?php echo $fasilitas->judul_page ?></h3>
